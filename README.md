...
| **Computación Evolutiva**        | Área de la inteligencia artificial que incluye los Algoritmos Genéticos, basada en mecanismos de evolución y selección natural. **Relacionado con**: Programación Evolutiva.                                                                |

| **Población de Soluciones Codificadas** | Conjunto de posibles soluciones a un problema, representadas como cromosomas en los AG. **Relacionado con**: Codificación Binaria.                                                                                                          |
